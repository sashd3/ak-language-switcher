...
### Added
- Admin option **"Capitalize language names"** (default: enabled) — toggle between linguistically correct native casing (e.g. "français", "italiano") and visually consistent capitalized display (e.g. "Français", "Italiano") ([#3](https://github.com/sashd3/ak-language-switcher/pull/3))

### Changed
- Admin section name now uses sentence case (`Language switcher`) to match the Nextcloud UI style guide; section heading is now properly translatable ([#2](https://github.com/sashd3/ak-language-switcher/pull/2))
...
[1.0.2]: https://github.com/sashd3/ak-language-switcher/releases/tag/v1.0.2
